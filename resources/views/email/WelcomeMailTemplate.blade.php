            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:10px" class="card">
                ...
                <tr>
                    <td align="center" style="padding:16px 28px 8px 28px;">
                        <div class="code" style="display:inline-block;font:700 28px/1.1 'SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace;letter-spacing:4px;color:#111;background:#f1f3f4;border:1px solid #e5e7eb;border-radius:8px;padding:14px 18px;">
                         {{ $otp }}
                        </div>
                    </td>
                </tr>
